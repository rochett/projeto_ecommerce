    ...
    <div class="container-fluid">
        ...
        <div class="breadcrumbs">
            <ul>
                ...
                <li>
                    <a href="#">Listagem de Categorias de Produtos</a>
                </li>
            </ul>
            ...
            <div class="span12">
                <div class="box box-color box-bordered">
                    <div class="box-title">
                        ...
                        <div class="actions">
                            <a href="cad_categoria_produto.php" class="btn" rel="tooltip"
                               title="Cadastrar Categoria de Produto"><i class="icon-save"></i></a>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover table-nomargin dataTable table-bordered dataTable-buttonTools">
                            ...
                            while ($row = mysqli_fetch_assoc($res)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="alt_categoria_produto.php?var_cat=<?php echo $row['id']; ?>"
                                           class="btn" rel="tooltip" title="Editar"><i class="icon-edit"></i></a>
                                        <a href="#"
                                           onClick="confirmDelete('exclui_categoria_produto.php?var_cat=',<?php echo $row['id']; ?>)"
