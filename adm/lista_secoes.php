...
<div id="main">
    <div class="container-fluid">
        <div class="page-header">
            <div class="pull-left">
                <h1>Listagem de Seções da Loja</h1>
            </div>
        ...
        <div class="breadcrumbs">
            <ul>
                ...
                <li>
                    <a href="#">Listagem de Seções da Loja</a>
                </li>
            </ul>
            ...
            <div class="span12">
                <div class="box box-color box-bordered">
                    <div class="box-title">
                        ...
                        <div class="actions">
                            <a href="cad_secoes.php" class="btn" rel="tooltip" title="Cadastrar Seções da Loja"><i
                                        class="icon-save"></i></a>
                        </div>
                    </div>
                    <div class="box-content nopadding">
                        <table class="table table-hover table-nomargin dataTable table-bordered dataTable-buttonTools">
                            ...
                            <tbody>
                            <?php
                            $sql = "SELECT * FROM secoes_site ORDER BY titulo";
                            $res = mysqli_query($conectar, $sql);
                            while ($row = mysqli_fetch_assoc($res)) {
                                ?>
                                <tr>
                                    <td><?php echo utf8_encode($row['titulo']); ?></td>
                                    <td><?php echo reduzTexto($row['texto']); ?></td>
                                    <td><?php echo exibeImagem(70, 93, $_SESSION['pasta_secoes'], $row['imagem']) ?></td>
                                    <td><?php echo exibeData($row['dat_cadastro']); ?></td>
                                    <td><?php echo $row['hor_cadastro']; ?></td>
                                    <td><?php echo utf8_encode($row['responsavel']); ?></td>
                                    <td>
                                        <a href="alt_secoes.php?var_sec=<?php echo $row['id']; ?>" class="btn"
                                           rel="tooltip" title="Editar"><i class="icon-edit"></i></a>
                                        <a href="#"
                                           onClick="confirmDelete('exclui_secoes.php?var_sec=',<?php echo $row['id']; ?>)"
