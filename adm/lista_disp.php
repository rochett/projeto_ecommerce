...
<div id="main">
    <div class="container-fluid">
        <div class="page-header">
            <div class="pull-left">
                <h1>Listagem de Disponibilidade</h1>
            </div>
        ...
        <div class="breadcrumbs">
            <ul>
                ...
                <li>
                    <a href="#">Listagem de Disponibilidade</a>
                </li>
            </ul>
            ...
            <div class="span12">
                <div class="box box-color box-bordered">
                    <div class="box-title">
                        ...
                        <div class="actions">
                            <a href="cad_disp.php" class="btn" rel="tooltip" title="Cadastrar Disponibilidade"><i
                                        class="icon-save"></i></a>
                        </div>
                    </div>
                    <div class="box-content nopadding">
                        <table class="table table-hover table-nomargin dataTable table-bordered dataTable-buttonTools">
                            ...
                            <tbody>
                            <?php
                            $sql = "SELECT * FROM disponibilidade ORDER BY descricao";
                            ...
                            while ($row = mysqli_fetch_assoc($res)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="alt_disp.php?var_disp=<?php echo $row['id']; ?>" class="btn"
                                           rel="tooltip" title="Editar"><i class="icon-edit"></i></a>
                                        <a href="#"
                                           onClick="confirmDelete('exclui_disp.php?var_disp=',<?php echo $row['id']; ?>)"
