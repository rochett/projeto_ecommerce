...
<div id="main">
    <div class="container-fluid">
        <div class="page-header">
            <div class="pull-left">
                <h1>Listagem de Slider da Loja</h1>
            </div>
        ...
        <div class="breadcrumbs">
            <ul>
                ...
                <li>
                    <a href="#">Listagem de Slider da Loja</a>
                </li>
            </ul>
            ...
            <div class="span12">
                <div class="box box-color box-bordered">
                    <div class="box-title">
                        ...
                        <div class="actions">
                            <a href="cad_slider.php" class="btn" rel="tooltip" title="Cadastrar Slider"><i
                                        class="icon-save"></i></a>
                        </div>
                    </div>
                    <div class="box-content nopadding">
                        <table class="table table-hover table-nomargin dataTable table-bordered dataTable-buttonTools">
                            ...
                            <tbody>
                            <?php
                            $sql = "SELECT * FROM slider_site ORDER BY id ASC";
                            ...
                            while ($row = mysqli_fetch_assoc($res)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo exibeImagem(180, 120, $_SESSION['pasta_imagens_slider'], $row['imagem']) ?></td>
                                    <td><?php echo exibeValor($row['exibir']); ?></td>
                                    <td><?php echo exibeData($row['dat_cadastro']); ?></td>
                                    <td><?php echo $row['hor_cadastro']; ?></td>
                                    <td><?php echo utf8_encode($row['responsavel']); ?></td>
                                    <td>
                                        <a href="alt_slider.php?var_sli=<?php echo $row['id']; ?>" class="btn"
                                           rel="tooltip" title="Editar"><i class="icon-edit"></i></a>
                                        <a href="#"
                                           onClick="confirmDelete('exclui_slider.php?var_sli=',<?php echo $row['id']; ?>)"
