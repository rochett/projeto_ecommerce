            ...
            <div class="span12">
                <div class="box box-color box-bordered">
                    <div class="box-title">
                        ...
                        <div class="actions">
                            <a href="cad_tamanho.php" class="btn" rel="tooltip" title="Cadastrar Tamanho"><i
                                        class="icon-save"></i></a>
                        </div>
                    </div>
                    <div class="box-content nopadding">
                        <table class="table table-hover table-nomargin dataTable table-bordered dataTable-buttonTools">
                            ...
                            <tbody>
                            <?php
                            $sql = "SELECT * FROM tamanho ORDER BY descricao";
                            ...
                            while ($row = mysqli_fetch_assoc($res)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="alt_tamanho.php?var_tam=<?php echo $row['id']; ?>" class="btn"
                                           rel="tooltip" title="Editar"><i class="icon-edit"></i></a>
                                        <a href="#"
                                           onClick="confirmDelete('exclui_tamanho.php?var_tam=',<?php echo $row['id']; ?>)"
