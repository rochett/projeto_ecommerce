            ...
            <div class="span12">
                <div class="box box-bordered">
                    ...
                    <div class="box-content nopadding">
                        <form action="efetua_cad_status.php" method="POST" class='form-horizontal form-striped'>
                            <div class="control-group">
                                <label for="password" class="control-label">Descrição</label>
                                <div class="controls">
                                    <input type="text" name="nome_status" id="nome_status" class="input-xlarge"
                                           placeholder="Informe o status" rel="tooltip" title="Descrição do Status"
                                           required>
                                </div>
                            </div>
