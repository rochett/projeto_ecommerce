    ...
    <div class="container-fluid">
        ...
        <div class="breadcrumbs">
            <ul>
                ...
                <li>
                    <a href="#">Cadastro de Disponibilidade</a>
                </li>
            </ul>
            ...
            <div class="span12">
                <div class="box box-bordered">
                    ...
                    <div class="box-content nopadding">
                        <form action="efetua_cad_disp.php" method="POST" class='form-horizontal form-striped'>
                            <div class="control-group">
                                <label for="password" class="control-label">Descrição</label>
                                <div class="controls">
                                    <input type="text" name="nome_disponibilidade" id="nome_disponibilidade"
                                           class="input-xlarge" placeholder="Informe a descrição da disponibilidade"
                                           rel="tooltip" title="Descrição da Disponibilidade" required>
                                </div>
                            </div>
