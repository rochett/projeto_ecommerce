				...
				<div class="span12">
					<div class="box box-color box-bordered">
						<div class="box-title">
							<h3>
								<i class="icon-user"></i>
								Alteração/Verificação de dados - <?php echo $_SESSION['utiliza']; ?>
							</h3>
						</div>
									...
									<form action="efetua_senha.php" class="form-horizontal" method="post">
											<div class="span10">
												<div class="control-group">
													...
													<div class="controls">
														<p align="center">Após a confirmação da NOVA SENHA, o sistema retornará à tela inicial<br>                                    
													...
													<div class="controls">
														<input type="text" name="senha_antiga" id="senha_antiga" class='input-xlarge' value="<?php echo $_SESSION['senha_acesso']; ?>" readonly>
													</div>
                                                    <br>
                                                    <label for="pw" class="control-label right">Nova Senha:</label>
													<div class="controls">
														<input type="text" name="nova_senha" id="nova_senha" class='input-xlarge' value="" rel="tooltip" title="Informe uma nova senha" placeholder="Informe uma nova senha" required>
													</div>
