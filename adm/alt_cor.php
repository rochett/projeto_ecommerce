...
$id_cor = $_GET['var_cor'];
$row_Recordset = montaQuery($id_cor, 'cor', $conectar);
?>
<body>
<?php
            ...
            <div class="span12">
                <div class="box box-bordered">
                    ...
                    <div class="box-content nopadding">
                        <form action="altera_cad_cor.php?var_cor=<?php echo $id_cor ?>" method="POST"
                              class='form-horizontal form-striped'>
                            <div class="control-group">
                                <label for="password" class="control-label">Descrição</label>
                                <div class="controls">
                                    <input name="nome_cor" type="text" class="input-xlarge" id="nome_cor"
                                           placeholder="Informe o nome da cor" title="Nome da Cor"
