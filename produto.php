                    ...
                    <div class="product-info">
                        <div class="left">
                            <div class="image">
                                ...
                                <a href="image_produto/<?php echo $row_RecordsetProduto['imagem_ampliar']; ?>"
                            ...
                            <div class="image-additional">
                                <a href="produto_imagem.php?var=<?php echo $filtra_produto; ?>"
                            ...
                            <a id="mapa" href="amplia_produto.php?var=<?php echo $row_RecordsetProduto['id']; ?>"
                               class="contact"><img src="image/ampliar.png" width="30" height="30" border="0"></a>&nbsp;<a
                                    id="mapa2"
                                    href="amplia_produto.php?var=<?php echo $row_RecordsetProduto['id']; ?>&pagina=normal"
                        ...
                        <div class="right">
                            <div class="description">
                                ...
                                ?>
                                <form action="calcular_frete.php?produto=<?php echo $filtra_produto; ?>&pag_retorno=1" method="post"
                                ...
                                <div>
                                    ...
                                    <div class="right">
                                        ...
                                        <div>
                                            ...
                                            <br><br>
                                            <?php $compra = array($filtra_produto, utf8_encode($row_RecordsetProduto['nome']), $cep_destino, $quantidade, $servico, $prazo_servico, $valor_servico,  $valor_produto, $cor, $tamanho, $row_RecordsetProduto['loja']); ?>
...
<div id="finalizarCompra" class="modal fade" role="dialog">
    <?php
    list($a, $b, $c, $d, $e, $f, $g, $h, $i, $j, $k) = $compra;
