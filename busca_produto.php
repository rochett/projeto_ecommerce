<?php 
    ...
    $filtro_buscaproduto = utf8_decode($_GET['pega_produto']);
    $filtro_lojas = $_SESSION['lojasbuscadas'];
    $tipo_lista = 'busca';
    ...
    $sql="SELECT * FROM produtos WHERE nome LIKE '%$filtro_buscaproduto%' AND exibir_produto=1 ORDER BY $filtro_ordem";
    include('config/paginator.php');
    $sql2="SELECT * FROM produtos WHERE nome LIKE '%$filtro_buscaproduto%' AND exibir_produto=1 ORDER BY $filtro_ordem LIMIT $inicio,$maximo";
                ...
                <div id="content">
                    ...
                    <div class="pav-pagination pagination">
                        ...
                        <?php
                            ...
                            $sql3="SELECT * FROM produtos WHERE nome LIKE '%$filtro_buscaproduto%' AND exibir_produto=1 ORDER BY $filtro_ordem LIMIT $p_ini,$maximo";
